 ...
 * Copyright (C) 2016  Francisco Javier Trujillo  javier.trujillo.jimenez@gmail.com
 *
...
class factura_detallada extends fs_controller {
   ...
   private function share_extensions() {
      ...
      foreach ($arrayidiomas as $arrayidio) {
          ...
          {
              array_unshift($extensiones,
                  array(
                      'name' => 'factura_'.$arrayidio->abreviatura,
                      'page_from' => __CLASS__,
                      'page_to' => 'ventas_factura',
                      'type' => 'pdf',
                      'text' => 'Factura en '.$arrayidio->idioma,
                      'params' => '&abreviatura='.$arrayidio->abreviatura
                  )    
              );
          }
